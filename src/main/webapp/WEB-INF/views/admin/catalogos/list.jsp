...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
  ...
  <div class="app-body">
    ...
    <main class="main">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><spring:message code="seccatalogs" /></li>
        ...
        <div class="animated fadeIn">
          <div class="card">
            <div class="card-header">
              <i class="fa fa-archive"></i> <spring:message code="seccatalogsform" />
  ...
  <spring:url value="/resources/js/views/Catalogos.js" var="searchCatalogoScript" />
  <script src="${searchCatalogoScript}"></script>
  <spring:url value="/admin/catalogos/catalogos/" var="catalogosUrl"/>
  <spring:url value="/admin/catalogos/editCatalogo/" var="editCatalogoUrl"/>
